...
async def connect_to_db() -> None:
    ...
    try:
        ...
        if settings.DATABASE_URL:
            ...
            print(f"[DB] 🔗 使用配置项连接数据库: {settings.DB_HOST}:{settings.DB_PORT}/{settings.DB_NAME}")
...
def get_pool() -> Optional[asyncpg.Pool]:
    ...
    Returns:
        Optional[asyncpg.Pool]: 连接池对象，如果未初始化则返回 None
